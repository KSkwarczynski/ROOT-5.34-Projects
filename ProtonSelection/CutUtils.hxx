...
namespace cutUtils{
  ...
  void FindGoodQualityTPCProtonsInFGDFV(const AnaEventC& event, multipart::MultiParticleBox& protonBox, const multipart::ProtonSelectionParams& params);
  ...
  namespace numuCCTrkMultiPi{
    ...
    protected:  
      bool _posPionMode;
        ...
        //WARNING
    class  nProtonCutBase: public StepBase, MultiParticleBoxGetter{
    public:
      using StepBase::Apply;

      bool Apply(AnaEventC& event, ToyBoxB& box) const; 
      StepBase* MakeClone(){return new nProtonCutBase();}
    protected:  
    };

        //WARNING
    class  ZeroProtonCutBase: public StepBase, MultiParticleBoxGetter{
    public:
      using StepBase::Apply;

      bool Apply(AnaEventC& event, ToyBoxB& box) const; 
      StepBase* MakeClone(){return new ZeroProtonCutBase();}
    protected:  
    };
    ...
    class ECalPi0VetoCutBase: public StepBase, MultiParticleBoxGetter{  
    public:
      using StepBase::Apply;
      bool Apply(AnaEventC& event, ToyBoxB& box) const;

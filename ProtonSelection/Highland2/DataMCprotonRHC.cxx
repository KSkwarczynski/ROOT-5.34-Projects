...
void DataMCprotonRHC()
{
    ...
    DrawingTools draw("/mnt/home/share/t2k/kskwarczynski/HighlandOutput/OutputRHC/Run5MC.root");

    Experiment exp("nd280");

    DataSample* R5Mc = new DataSample("/mnt/home/share/t2k/kskwarczynski/HighlandOutput/OutputRHC/Run5MC.root");
    DataSample* R5MC_sand = new DataSample("/mnt/home/share/t2k/kskwarczynski/HighlandOutput/OutputRHC/SandRHC.root");
    DataSample* R5Data = new DataSample("/mnt/home/share/t2k/kskwarczynski/HighlandOutput/OutputRHC/DataRun5.root");
    ...
    DataSample* R6Mc = new DataSample("/mnt/home/share/t2k/kskwarczynski/HighlandOutput/OutputRHC/Run6MC.root");
    DataSample* R6MC_sand = new DataSample("/mnt/home/share/t2k/kskwarczynski/HighlandOutput/OutputRHC/SandRHC.root");
    DataSample* R6Data = new DataSample("/mnt/home/share/t2k/kskwarczynski/HighlandOutput/OutputRHC/DataRun6.root");
    ...
    DataSample* R7Mc = new DataSample("/mnt/home/share/t2k/kskwarczynski/HighlandOutput/OutputRHC/Run7MC.root");
    DataSample* R7MC_sand = new DataSample("/mnt/home/share/t2k/kskwarczynski/HighlandOutput/OutputRHC/SandRHC.root");
    DataSample* R7Data = new DataSample("/mnt/home/share/t2k/kskwarczynski/HighlandOutput/OutputRHC/DataRun7.root");
    ...
    DataSample* R9Mc = new DataSample("/mnt/home/share/t2k/kskwarczynski/HighlandOutput/OutputRHC/Run9MC.root");
    DataSample* R9MC_sand = new DataSample("/mnt/home/share/t2k/kskwarczynski/HighlandOutput/OutputRHC/SandRHC.root");
    DataSample* R9Data = new DataSample("/mnt/home/share/t2k/kskwarczynski/HighlandOutput/OutputRHC/DataRun9.root");
    ...
    draw.Draw(exp, "true_Q2/1000", 20., 0., 1000, "reaction", "accum_level[0][0][0]>7 && nProtonsFGD == 0 && nProtonsTPC==0", "");
    c1->Print("ProtonSelecPlotsNew.pdf", "pdf");
    
    draw.SetLegendPos("tr");
    draw.SetTitle("CC0#pi-Np RHC FGD1");
    draw.SetTitleX("True Q^{2}");
    draw.Draw(exp, "true_Q2/1000", 20., 0., 1000, "reaction", "accum_level[0][0][0]>7 && (nProtonsFGD + nProtonsTPC) > 0", "");
    c1->Print("ProtonSelecPlotsNew.pdf", "pdf");

...
/**
 ...
 Cuts for Branch 1: This is the branch requiring no pions and n Protons
  <table>
  <tr><th> #cut  <th> cut class                        <th>  from source file   <th>  Cut description
  <tr><td> 6     <td> ExternalVetoCut::Apply           <td> numuCCSelection.cxx <td> External veto cut 
  <tr><td> 7     <td> ExternalFGD1lastlayersCut::Apply <td> numuCCSelection.cxx <td> External FGD1 last layers cut
  ...
  Cuts for Branch 2: This is the branch requiring 1 and only 1 pion
  <table>
  <tr><th> #cut  <th> cut class                        <th>  from source file   <th>  Cut description
  <tr><td> 6     <td> ExternalVetoCut::Apply           <td> numuCCSelection.cxx <td> External veto cut 
  <tr><td> 7     <td> ExternalFGD1lastlayersCut::Apply <td> numuCCSelection.cxx <td> External FGD1 last layers cut
  ...
  Cuts for Branch 3: This is the branch requiring more than 1 pion
  <table>
  <tr><th> #cut  <th> cut class                        <th>  from source file   <th>  Cut description
  <tr><td> 6     <td> ExternalVetoCut::Apply           <td> numuCCSelection.cxx <td> External veto cut 
  <tr><td> 7     <td> ExternalFGD1lastlayersCut::Apply <td> numuCCSelection.cxx <td> External FGD1 last layers cut
...
void numuCCMultiPiSelection::DefineSteps(){
  ...
  AddStep(1, StepBase::kCut, "n Protons",     new nProtonCut());  //WARNING
  
  //third branch is for CC-1pi: true -- Positive pion
  AddStep(2, StepBase::kCut, "CC-1pi",        new OnePionCut(true));

  AddStep(2, StepBase::kCut, "ECal Pi0 veto", new EcalPi0VetoCut());
...
bool numuCCMultiPiSelection::FillEventSummary(AnaEventC& event, Int_t allCutsPassed[]){
  ...
  //CC0piNp
  if(allCutsPassed[1]){
    static_cast<AnaEventSummaryB*>(event.Summary)->EventSample = SampleId::kFGD1NuMuCC0PiNp; //WARNING
  } 
  //CC1pi
...
bool FillSummaryAction_numuCCMultiPi::Apply(AnaEventC& event, ToyBoxB& boxB) const{
  ...
  static_cast<AnaEventSummaryB*>(event.Summary)->LeptonCandidate[SampleId::kFGD1NuMuCC0PiNp]   = box.HMNtrack; //WARNING
  ...
  static_cast<AnaEventSummaryB*>(event.Summary)->PionCandidate[SampleId::kFGD1NuMuCC0Pi]   = 
    box.pionBox.GetHMPion(static_cast<AnaEventSummaryB*>(event.Summary)->PionMomentum[SampleId::kFGD1NuMuCC0Pi], 
        static_cast<AnaEventSummaryB*>(event.Summary)->PionDirection[SampleId::kFGD1NuMuCC0Pi]);
  //WARNING
  static_cast<AnaEventSummaryB*>(event.Summary)->PionCandidate[SampleId::kFGD1NuMuCC0PiNp]   = 
    box.pionBox.GetHMPion(static_cast<AnaEventSummaryB*>(event.Summary)->PionMomentum[SampleId::kFGD1NuMuCC0PiNp], 
        static_cast<AnaEventSummaryB*>(event.Summary)->PionDirection[SampleId::kFGD1NuMuCC0PiNp]);
    
  static_cast<AnaEventSummaryB*>(event.Summary)->PionCandidate[SampleId::kFGD1NuMuCC1Pi]   = 
    box.pionBox.GetHMPion(static_cast<AnaEventSummaryB*>(event.Summary)->PionMomentum[SampleId::kFGD1NuMuCC1Pi], 
        static_cast<AnaEventSummaryB*>(event.Summary)->PionDirection[SampleId::kFGD1NuMuCC1Pi]);
  
  static_cast<AnaEventSummaryB*>(event.Summary)->PionCandidate[SampleId::kFGD1NuMuCCOther] = 
    box.pionBox.GetHMPion(static_cast<AnaEventSummaryB*>(event.Summary)->PionMomentum[SampleId::kFGD1NuMuCCOther], 
        static_cast<AnaEventSummaryB*>(event.Summary)->PionDirection[SampleId::kFGD1NuMuCCOther]);

  // Fill proton candidates
  static_cast<AnaEventSummaryB*>(event.Summary)->ProtonCandidate[SampleId::kFGD1NuMuCC0Pi]   = 
    box.pionBox.GetHMProton(static_cast<AnaEventSummaryB*>(event.Summary)->ProtonMomentum[SampleId::kFGD1NuMuCC0Pi], 
        static_cast<AnaEventSummaryB*>(event.Summary)->ProtonDirection[SampleId::kFGD1NuMuCC0Pi]);
  //WARNING
  static_cast<AnaEventSummaryB*>(event.Summary)->ProtonCandidate[SampleId::kFGD1NuMuCC0PiNp]   = 
    box.pionBox.GetHMProton(static_cast<AnaEventSummaryB*>(event.Summary)->ProtonMomentum[SampleId::kFGD1NuMuCC0PiNp], 
        static_cast<AnaEventSummaryB*>(event.Summary)->ProtonDirection[SampleId::kFGD1NuMuCC0PiNp]);
    
  static_cast<AnaEventSummaryB*>(event.Summary)->ProtonCandidate[SampleId::kFGD1NuMuCC1Pi]   = 
    box.pionBox.GetHMProton(static_cast<AnaEventSummaryB*>(event.Summary)->ProtonMomentum[SampleId::kFGD1NuMuCC1Pi],
        static_cast<AnaEventSummaryB*>(event.Summary)->ProtonDirection[SampleId::kFGD1NuMuCC1Pi]);
  
  static_cast<AnaEventSummaryB*>(event.Summary)->ProtonCandidate[SampleId::kFGD1NuMuCCOther] = 
    box.pionBox.GetHMProton(static_cast<AnaEventSummaryB*>(event.Summary)->ProtonMomentum[SampleId::kFGD1NuMuCCOther], 
        static_cast<AnaEventSummaryB*>(event.Summary)->ProtonDirection[SampleId::kFGD1NuMuCCOther]);
  
  for (int i = 0; i < 4; ++i){
    static_cast<AnaEventSummaryB*>(event.Summary)->VertexPosition[SampleId::kFGD1NuMuCC0Pi][i]     = box.HMNtrack->PositionStart[i];
    static_cast<AnaEventSummaryB*>(event.Summary)->VertexPosition[SampleId::kFGD1NuMuCC0PiNp][i]   = box.HMNtrack->PositionStart[i];
  ...
  if (box.HMNtrack->GetTrueParticle()){
    ...
    static_cast<AnaEventSummaryB*>(event.Summary)->TrueVertex[SampleId::kFGD1NuMuCC0PiNp]   = box.HMNtrack->GetTrueParticle()->TrueVertex;
  ...
  // Topologies
  static_cast<AnaEventSummaryB*>(event.Summary)->SelPionTopo[SampleId::kFGD1NuMuCC0Pi]     = box.pionBox.GetPionTopo();
  static_cast<AnaEventSummaryB*>(event.Summary)->SelPionTopo[SampleId::kFGD1NuMuCC0PiNp]   = box.pionBox.GetPionTopo();
  static_cast<AnaEventSummaryB*>(event.Summary)->SelPionTopo[SampleId::kFGD1NuMuCC1Pi]     = box.pionBox.GetPionTopo();
  static_cast<AnaEventSummaryB*>(event.Summary)->SelPionTopo[SampleId::kFGD1NuMuCCOther]   = box.pionBox.GetPionTopo();

  static_cast<AnaEventSummaryB*>(event.Summary)->SelProtonTopo[SampleId::kFGD1NuMuCC0Pi]     = box.pionBox.GetProtonTopo();
  static_cast<AnaEventSummaryB*>(event.Summary)->SelProtonTopo[SampleId::kFGD1NuMuCC0PiNp]   = box.pionBox.GetProtonTopo();
  static_cast<AnaEventSummaryB*>(event.Summary)->SelProtonTopo[SampleId::kFGD1NuMuCC1Pi]     = box.pionBox.GetProtonTopo();
  static_cast<AnaEventSummaryB*>(event.Summary)->SelProtonTopo[SampleId::kFGD1NuMuCCOther]   = box.pionBox.GetProtonTopo();
...
//*********************************************************************
bool FindProtonsAction::Apply(AnaEventC& event, ToyBoxB& box) const{
  //*********************************************************************
  ...
  const ToyBoxCCMultiPi* ccmultipibox = static_cast<const ToyBoxCCMultiPi*>(&box);
    ...
    switch (systId){
      ...
      case SystId::kECalPiZeroVetoPileUp:
        ...
        // For branch==3,  apply if the ECal is the one that defines the topology

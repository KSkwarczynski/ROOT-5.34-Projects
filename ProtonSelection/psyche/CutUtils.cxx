...
//*********************************************************************
void cutUtils::FindGoodQualityTPCPionInfoInFGDFV(const AnaEventC& event, const AnaTrackB* reftrack, multipart::MultiParticleBox& pionBox, 
...
//*********************************************************************
bool cutUtils::numuCCTrkMultiPi::CheckTrueCausesBoxSimple(const AnaTrueParticleB& trueTrack, const multipart::MultiParticleBox& box){
  //*********************************************************************
...
//WARNING
//*********************************************************************
bool cutUtils::numuCCTrkMultiPi::nProtonCutBase::Apply(AnaEventC& event, ToyBoxB& box) const{
  //*********************************************************************
  ...
  if ( (pionBox.nProtonFGDtracks+pionBox.nProtonTPCtracks)>0 ) return true; 
...
//WARNING
//*********************************************************************
bool cutUtils::numuCCTrkMultiPi::ZeroProtonCutBase::Apply(AnaEventC& event, ToyBoxB& box) const{
  //*********************************************************************
  ...
  if ( pionBox.nProtonFGDtracks==0 && pionBox.nProtonTPCtracks==0 ) return true; 

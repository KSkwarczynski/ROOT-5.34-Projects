...
void numuCCMultiPiFGD2Selection::DefineSteps(){
  ...
  //First branch is for CC-0piNp TODO trzeba to zamineic pozniej z pierwszym
  AddStep(3, StepBase::kCut, "CC-0pi",        new NoPionCut());

  AddStep(3, StepBase::kCut, "ECal Pi0 veto", new EcalPi0VetoCut());

  AddStep(3, StepBase::kCut, "n Protons",     new nProtonCut());  //WARNING
  ...
  SetBranchAlias(3,"CC-0piNp",  3); //WARNING
...
bool numuCCMultiPiFGD2Selection::FillEventSummary(AnaEventC& event, Int_t allCutsPassed[]){
  ...
  //CC0piNp
    ...
    static_cast<AnaEventSummaryB*>(event.Summary)->EventSample = SampleId::kFGD2NuMuCC0PiNp; //WARNING
  } 
...
bool FillSummaryAction_numuCCMultiPiFGD2::Apply(AnaEventC& event, ToyBoxB& boxB) const{
  ...
  static_cast<AnaEventSummaryB*>(event.Summary)->LeptonCandidate[SampleId::kFGD2NuMuCC0PiNp]   = box.HMNtrack; //WARNING
  ...
  static_cast<AnaEventSummaryB*>(event.Summary)->PionCandidate[SampleId::kFGD2NuMuCC0Pi]   = 
    box.pionBox.GetHMPion(static_cast<AnaEventSummaryB*>(event.Summary)->PionMomentum[SampleId::kFGD2NuMuCC0Pi], 
       static_cast<AnaEventSummaryB*>(event.Summary)->PionDirection[SampleId::kFGD2NuMuCC0Pi]); 
  
    //WARNING
  static_cast<AnaEventSummaryB*>(event.Summary)->PionCandidate[SampleId::kFGD2NuMuCC0PiNp]   = 
    box.pionBox.GetHMPion(static_cast<AnaEventSummaryB*>(event.Summary)->PionMomentum[SampleId::kFGD2NuMuCC0PiNp], 
        static_cast<AnaEventSummaryB*>(event.Summary)->PionDirection[SampleId::kFGD2NuMuCC0PiNp]);
    
  static_cast<AnaEventSummaryB*>(event.Summary)->PionCandidate[SampleId::kFGD2NuMuCC1Pi]   = 
    box.pionBox.GetHMPion(static_cast<AnaEventSummaryB*>(event.Summary)->PionMomentum[SampleId::kFGD2NuMuCC1Pi], 
       static_cast<AnaEventSummaryB*>(event.Summary)->PionDirection[SampleId::kFGD2NuMuCC1Pi]); 
  
  static_cast<AnaEventSummaryB*>(event.Summary)->PionCandidate[SampleId::kFGD2NuMuCCOther] = 
    box.pionBox.GetHMPion(static_cast<AnaEventSummaryB*>(event.Summary)->PionMomentum[SampleId::kFGD2NuMuCCOther], 
        static_cast<AnaEventSummaryB*>(event.Summary)->PionDirection[SampleId::kFGD2NuMuCCOther]);

  // Fill proton candidates
  static_cast<AnaEventSummaryB*>(event.Summary)->ProtonCandidate[SampleId::kFGD2NuMuCC0Pi]   = 
    box.pionBox.GetHMProton(static_cast<AnaEventSummaryB*>(event.Summary)->ProtonMomentum[SampleId::kFGD2NuMuCC0Pi], 
        static_cast<AnaEventSummaryB*>(event.Summary)->ProtonDirection[SampleId::kFGD2NuMuCC0Pi]);
  
      //WARNING
  static_cast<AnaEventSummaryB*>(event.Summary)->ProtonCandidate[SampleId::kFGD2NuMuCC0PiNp]   = 
    box.pionBox.GetHMProton(static_cast<AnaEventSummaryB*>(event.Summary)->ProtonMomentum[SampleId::kFGD2NuMuCC0PiNp], 
        static_cast<AnaEventSummaryB*>(event.Summary)->ProtonDirection[SampleId::kFGD2NuMuCC0PiNp]);
    
  static_cast<AnaEventSummaryB*>(event.Summary)->ProtonCandidate[SampleId::kFGD2NuMuCC1Pi]   = 
    box.pionBox.GetHMProton(static_cast<AnaEventSummaryB*>(event.Summary)->ProtonMomentum[SampleId::kFGD2NuMuCC1Pi], 
        static_cast<AnaEventSummaryB*>(event.Summary)->ProtonDirection[SampleId::kFGD2NuMuCC1Pi]);
  
  static_cast<AnaEventSummaryB*>(event.Summary)->ProtonCandidate[SampleId::kFGD2NuMuCCOther] = 
    box.pionBox.GetHMProton(static_cast<AnaEventSummaryB*>(event.Summary)->ProtonMomentum[SampleId::kFGD2NuMuCCOther], 
        static_cast<AnaEventSummaryB*>(event.Summary)->ProtonDirection[SampleId::kFGD2NuMuCCOther]);
  

  for (int i = 0; i < 4; ++i){
    static_cast<AnaEventSummaryB*>(event.Summary)->VertexPosition[SampleId::kFGD2NuMuCC0Pi][i]   = box.HMNtrack->PositionStart[i];
    static_cast<AnaEventSummaryB*>(event.Summary)->VertexPosition[SampleId::kFGD2NuMuCC0PiNp][i]   = box.HMNtrack->PositionStart[i]; //WARNING
  ...
  if (box.HMNtrack->GetTrueParticle()){
    ...
    static_cast<AnaEventSummaryB*>(event.Summary)->TrueVertex[SampleId::kFGD2NuMuCC0PiNp]   = box.HMNtrack->GetTrueParticle()->TrueVertex; //WARNING
  ...
  // Topologies
  static_cast<AnaEventSummaryB*>(event.Summary)->SelPionTopo[SampleId::kFGD2NuMuCC0Pi]   = box.pionBox.GetPionTopo();
  static_cast<AnaEventSummaryB*>(event.Summary)->SelPionTopo[SampleId::kFGD2NuMuCC0PiNp]   = box.pionBox.GetPionTopo();
  static_cast<AnaEventSummaryB*>(event.Summary)->SelPionTopo[SampleId::kFGD2NuMuCC1Pi]   = box.pionBox.GetPionTopo();
  static_cast<AnaEventSummaryB*>(event.Summary)->SelPionTopo[SampleId::kFGD2NuMuCCOther] = box.pionBox.GetPionTopo();

  static_cast<AnaEventSummaryB*>(event.Summary)->SelProtonTopo[SampleId::kFGD2NuMuCC0Pi]   = box.pionBox.GetProtonTopo();
  static_cast<AnaEventSummaryB*>(event.Summary)->SelProtonTopo[SampleId::kFGD2NuMuCC0PiNp]   = box.pionBox.GetProtonTopo();
  static_cast<AnaEventSummaryB*>(event.Summary)->SelProtonTopo[SampleId::kFGD2NuMuCC1Pi]   = box.pionBox.GetProtonTopo();
  static_cast<AnaEventSummaryB*>(event.Summary)->SelProtonTopo[SampleId::kFGD2NuMuCCOther] = box.pionBox.GetProtonTopo(); 

...
//*********************************************************
    ...
    else if (sample == kFGD1NuMuCC0PiNp)                  ssample = "FGD1 numuCC 0pi Np"; //WARNING
    ...
    else if (sample == kFGD2NuMuCC0PiNp)                  ssample = "FGD2 numuCC 0pi Np"; //WARNING
...
//*********************************************************
    ...
    else if (sample == kFGD1NuMuCC0PiNp)                  ssample = "kTrackerNumuCCMultiPi"; //WARNING
    ...
    else if (sample == kFGD2NuMuCC0PiNp)                  ssample = "kTrackerNumuCCMultiPiFGD2"; //WARNING
